...
from rsfms.models import PrithviModelFactory  # noqa: F401
from rsfms.models.model import AuxiliaryHead  # noqa: F401
from rsfms.tasks import (
...
def build_lightning_cli(
    ...
    if os.environ.get("rsfms_FLOAT_32_PRECISION") is not None:
        precision = os.environ.get("rsfms_FLOAT_32_PRECISION")
        allowed_values = ["highest", "high", "medium"]
        if precision in allowed_values:
            torch.set_float32_matmul_precision(precision)
        else:
            warnings.warn(
                "Found rsfms_FLOAT_32_PRECISION env variable but value was set to precision.\
