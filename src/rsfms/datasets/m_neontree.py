...
from rsfms.datasets.utils import to_tensor
...
class MNeonTreeNonGeo(NonGeoDataset):
    ...
    def __init__(
        self, data_root: str, bands: Sequence[str] = rgb_bands, transform: A.Compose | None = None, split="train"
    ) -> None:
        super().__init__()
        ...
        self.data_directory = data_root / "m-NeonTree"
    ...
    def plot(self, arg, suptitle: str | None = None) -> None:
        ...
        return self.plot_sample(sample, showing_predictions, suptitle)
