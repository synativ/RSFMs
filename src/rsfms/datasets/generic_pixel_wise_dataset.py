...
from rsfms.datasets.utils import HLSBands, filter_valid_files, to_tensor
    ...
    def __init__(
        ...
        Args:
            ...
            split (Path, optional): Path to file containing files to be used for this split.
                ...
                Files will be searched using glob with the form Path(data_root).glob(prefix + [image or label grep])
