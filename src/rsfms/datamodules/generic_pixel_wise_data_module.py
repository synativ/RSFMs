...
from rsfms.datasets import GenericNonGeoPixelwiseRegressionDataset, GenericNonGeoSegmentationDataset, HLSBands
...
class GenericNonGeoSegmentationDataModule(NonGeoDataModule):
    ...
    Composes several [GenericNonGeoSegmentationDatasets][rsfms.datasets.GenericNonGeoSegmentationDataset]
    """
...
class GenericNonGeoPixelwiseRegressionDataModule(NonGeoDataModule):
    """This is a generic datamodule class for instantiating data modules at runtime.
    Composes several
    [GenericNonGeoPixelwiseRegressionDataset][rsfms.datasets.GenericNonGeoPixelwiseRegressionDataset]
    """
