...
class GenericNonGeoClassificationDataModule(NonGeoDataModule):
    ...
    Composes several [GenericNonGeoClassificationDatasets][rsfms.datasets.GenericNonGeoClassificationDataset]
    """
...
# TODO: Will have to be adapted to get the labels
# class GenericNonGeoRegressionDataModule(NonGeoDataModule):
#     """This is a generic datamodule class for instantiating data modules at runtime.
#     Composes several
#     [GenericNonGeoRegressionDataset][rsfms.datasets.GenericNonGeoRegressionDataset]
#     """
...
#             drop_last (bool): Drop the last batch if it is not complete. Defaults to True.
#         """
#         super().__init__(GenericNonGeoRegressionDataset, batch_size, num_workers, **kwargs)
#         self.train_root = train_data_root
#         self.val_root = val_data_root
#         self.test_root = test_data_root
#         self.predict_root = predict_data_root
