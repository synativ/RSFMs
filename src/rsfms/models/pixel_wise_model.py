...
from rsfms.models.heads import RegressionHead, SegmentationHead
from rsfms.models.model import AuxiliaryHeadWithDecoderWithoutInstantiatedHead, Model, ModelOutput
