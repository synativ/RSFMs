...
from rsfms.io.file import open_generic_torch_model
...
from rsfms.models.scalar_output_model import ScalarOutputModel
    ...
    def build_model(
        ...
        **kwargs,
        ...
        Args:
            ...
            bands (list[rsfms.datasets.HLSBands], optional): Bands the model will be trained on.
                    Should be a list of rsfms.datasets.HLSBands.
        ...
        if not isinstance(backbone, nn.Module):
            ...
            try:
                ...
                backbone: nn.Module = ModelWrapper(
                    model=backbone_template(**backbone_kwargs), kind=backbone_kind, res=fixed_res
                )
